...
function YoutubeEmbed() {
  ...
  return (
    ...
    >
      <iframe
        src={`https://www.youtube.com/embed/${videoId}?autoplay=1&mute=1&loop=1&controls=0&playlist=${videoId}&rel=0`}
        loading="lazy"
...
function GoogleCharts() {
  console.log(GoogleCharts.name);

  return (
    <div>
      <div data-isolate className="relative m-auto aspect-video h-64">
        <GoogleChart
          type="PieChart"
          data={[
            ["Task", "Hours per Day"],
